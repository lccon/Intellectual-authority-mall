...
$.extend({
    ...
    layout:function(option){
    	function layoutFun(){
            var documentHeight =document.documentElement.clientHeight -$(".header-bar").outerHeight(true);
            var rightWidth     =document.documentElement.clientWidth-$(".content-wrapper").outerWidth(true)-40;
            ...
            if(window._currentGrid!=undefined && window._currentGrid.closest(".main")[0]) {
                window._currentGrid.setGridWidth(rightWidth-20)
                    .setGridHeight(documentHeight - $('.manage-area-title').outerHeight(true) - $('#operArea').outerHeight(true) - $('.ui-pager-control').outerHeight(true) - $('.ui-jqgrid-view .ui-jqgrid-hdiv').outerHeight(true) - 4);
            }
        }
        layoutFun();
